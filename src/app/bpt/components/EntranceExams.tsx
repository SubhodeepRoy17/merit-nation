...
const exams = [
  {
    name: "NEET",
    description: "National Eligibility cum Entrance Test, conducted nationwide for admission to medical courses.",
  },
  {
    name: "AIIMS",
    description: "All India Institute of Medical Sciences Entrance Exam for admission to AIIMS institutions.",
  },
