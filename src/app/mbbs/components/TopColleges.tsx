...
export default function TopColleges() {
  ...
  const colleges = [
    { rank: 1, name: "All India Institute of Medical Sciences, New Delhi", exams: "NEET-UG" },
    { rank: 2, name: "Post Graduate Institute of Medical Education and Research, Chandigarh", exams: "NEET-UG" },
    { rank: 3, name: "Christian Medical College, Vellore", exams: "NEET-UG, CMCVEE" },
    { rank: 4, name: "National Institute of Mental Health & Neuro Sciences, Bangalore", exams: "NEET-UG" },
    { rank: 5, name: "Jawaharlal Institute of Post Graduate Medical Education & Research, Puducherry", exams: "NEET-UG" },
  ];

  return (
    <section className="my-12 p-6 border-2 border-black dark:border-white rounded-lg">
      <h2 className="text-4xl font-bold mb-6 font-serif">Top 5 MBBS Colleges in India</h2>
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-1/3">
          <p className="font-verdana text-lg">
            These top medical colleges in India offer excellent MBBS programs and are known for their high-quality
            education, research facilities, and clinical exposure.
          </p>
        </div>
